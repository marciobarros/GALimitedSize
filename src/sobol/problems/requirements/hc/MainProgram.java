...
public class MainProgram
{
	...
	public static final void main(String[] args) throws Exception
	{
		...
		for (Project instance : instances)
		{
			...
			mp.runInstance(out, details, "PSEUDO", instance, 100, 0.8);
			...
			mp.runInstance(out, details, "SOBOL", instance, 1, 0.8);
			...
			mp.runInstance(out, details, "HALTON", instance, 1, 0.8);
			...
			mp.runInstance(out, details, "FAURE", instance, 1, 0.8);
		}
